...
import jp.artan.dmlreloaded.forge.container.slots.SlotExtractionChamber;
import jp.artan.dmlreloaded.forge.container.sync.ExtractionChamberContainerData;
...
public class ExtractionChamberContainer extends AbstractContainerMenu{
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(this.containerAccess, pPlayer, DMLBlocksForge.EXTRACTION_CHAMBER.get());
    }
