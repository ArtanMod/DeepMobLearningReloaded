...
public class RecipeSerializerInit {
    ...
    public static final RegistryObject<SimpleRecipeSerializer<SpawnEggShapelessRecipe>> CRAFTING_SPECIAL_SPAWN_EGG_RECIPE = RECIPE.register("crafting_special_spawn_egg", SpawnEggShapelessRecipe.Serializer::new);
