...
public class ContainerInit {
    ...
    public static final MenuEntry<SimulationChamberContainer> SIMULATION_CHAMBER = register("simulation_chamber", SimulationChamberContainer::new, () -> SimulationChamberScreen::new)
            ...
            .addRawLang("dmlreloaded.gui.simulation_chamber.tier1.1", "Insufficient data in model")
            .addRawJPLang("dmlreloaded.gui.simulation_chamber.tier1.1", "モデルのデータが不足しています")
            .addRawLang("dmlreloaded.gui.simulation_chamber.tier1.2", "please insert a basic model")
            .addRawJPLang("dmlreloaded.gui.simulation_chamber.tier1.2", "等級が基本以上のデータモデルを")
            .addRawLang("dmlreloaded.gui.simulation_chamber.tier1.3", "or better ")
            .addRawJPLang("dmlreloaded.gui.simulation_chamber.tier1.3", "挿入してください")
