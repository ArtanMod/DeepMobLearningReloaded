    ...
    public static void addLang(DeepMobLearningReloadedRegistrate registrate) {
        {
...

            {
                ...
                registrate.addRawJPLang("patchouli.category.1.introduction.text", "この章では$(item)Mod$()の基本を説明します。$(l:0_introduction/1_data)データ$()の学習を始めて、$(l:0_introduction/2_data_models#data_models)データモデルを作成することができます。");
                {
                ...
                }
                {
                    ...
                    registrate.addRawJPLang("patchouli.category.1.introduction.entry.3.page.1.text", "以前作った$(br)$(l:0_introduction/0_introduction#sooted_redstone)煤まみれのレッドストーン$()の一部で、$(item)空のデータモデル$()を作ることができます。");
                    ...
                    registrate.addRawJPLang("patchouli.category.1.introduction.entry.3.page.2.text", "全ての$(item)データモデルは「$(8)不完全$()」という階層から始まり、$(item)データモデル$()が多くの$(item)データ$()を学習するとこの等級は上がります。$(br2)$(item)等級$()が上がると、倒したモブからより多くの$(item)データ$()を獲得できます。$(br2)$(item)データモデル$()は、$(l:1_machines/0_simulation_chamber)シミュレーション室$()に入れてもよいです。");
                    ...
                    registrate.addRawJPLang("patchouli.category.1.introduction.entry.3.page.3.text", "$(item)データモデル$()は、$(item)生息地$()によって$(item)タイプ$()に分かれます。$(item)生息地$()の種類は、$(a)オーバーワールド$()、$(c)ネザー$()、$(d)エンド$()の3つです。 $(br2)データモデル$()のタイプによって、$(l:1_machines/1_matter#living)Living Matter$()や$(l:1_machines/1_matter#pristine)綺麗なマター$()のようなものを生成するかは、$(l:1_machines/0_simulation_chamber)シミュレーション室$()が決まります。");
            ...
            }
            {
                ...
                registrate.addRawJPLang("patchouli.category.2.introduction.text", "この章では、$(dml)$(br)の中の機械$(br2)すべての$(item)機械$()は、ブロックの上部から$(item)Inputs$()を受け入れることができます。他の側面は、$(item)Outputs$()のパイプに使われます。");

                {
                    ...
                    registrate.addRawJPLang("patchouli.category.2.introduction.entry.1.page.1.text", "$(item)シミュレーション室$()は、あなたの$(l:0_introduction/2_data_models)データモデル$()に保存されている情報を読み取り、そこから$(l:0_introduction/1_data)データ$()を作成することができる機械です。$(br2)この処理によって、現在使われている$(l:0_introduction/2_data_models)データモデル$()に、さらに$(l:0_introduction/1_data)データ$()が追加されます。$(br2)この処理には、$(a)基本$()(またはそれ以上)の等級の$(br)$(l:0_introduction/2_data_models)データモデル$()、$(l:1_machines/3_energy)のエネルギー$()と$(br)$(item)ポリマー粘土$()も必要です。");
                    ...
                    registrate.addRawJPLang("patchouli.category.2.introduction.entry.1.page.2.text", "$(item)シミュレーション室$()は、$(l:0_introduction/0_introduction#plates_and_casings)機械の枠で作られています。$(br2)運用$(item)エネルギー$()のコストは、どの$(l:0_introduction/2_data_models)データモデル$()が使われるかにより異なります。");
                ...
                }
                {
                    ...
                    registrate.addRawJPLang("patchouli.category.2.introduction.entry.2.page.1.text", "$(item)マター$()には、$(item)Living Matter$()と$(item)綺麗なマター$()の2種類があります。$(br2)$(l:1_machines/0_simulation_chamber)シミュレーション$()を行うと、必ず$(br2)$(item)Living Matter$()を1つ入手できます。$(br2)また、$(item)綺麗なマター$()を生成する確率もあり、その確率は$(l:0_introduction/2_data_models#data_models)データモデル$()の等級$()に依存してます。");
                    ...
                    registrate.addRawJPLang("patchouli.category.2.introduction.entry.2.page.2.text", "$(item)Living Matter$()は、その$(item)Living Matter$()はいろいろなアイテムに$(item)変換$()するのに使える万能な物質で、どんなレシピがあるかは$(item)JEI$()で確認してください。$(br2)$(item)Living Matter$()は消費して経験値も獲得できます。");
                    ...
                    registrate.addRawJPLang("patchouli.category.2.introduction.entry.2.page.4.text", "$(l:1_machines/0_simulation_chamber)シミュレーション室$()の2次出力です。$(br2)$(l:0_introduction/2_data_models#data_models)データモデル$()の種類によって、生産する$(item)綺麗なマター$()の種類が変わっています。$(br2)$(item)綺麗なマター$()は$(br)$(l:1_machines/2_loot_fabricator)Loot Fabricator$()でモブのドロップを生成します。");
                }
                {
                    ...
                    registrate.addRawJPLang("patchouli.category.2.introduction.entry.3.page.1.text", "$(item)Loot Fabricator$()は、よくできる機械です。$(item)綺麗なマター$()から戦利品を作ることができます。$(br2)戦利品を作るには$(l:1_machines/3_energy)エネルギー$()と$(item)アイテム$()を必要とします。");
