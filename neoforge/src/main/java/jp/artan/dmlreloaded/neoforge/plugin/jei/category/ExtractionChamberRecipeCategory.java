...
public class ExtractionChamberRecipeCategory implements IRecipeCategory<ExtractionChamberRecipeCategory.ExtractionChamberRecipes> {
    ...
    public ExtractionChamberRecipeCategory(IGuiHelper guiHelper) {
        ResourceLocation base = DeepMobLearningReloadedMod.getResource("textures/gui/jei/extraction_chamber.png");
        this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(DMLBlocksForge.EXTRACTION_CHAMBER.get()));
